...
@section('content')
    <h3>History Izin Mengeluarkan Barang</h3>
    <br>
    ...
    <script lang="text/javascript">
        $(function() {
            ...
            var table = $('.table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    'url': "{{ route('website.izin.ajax_show') }}",
                },
                columns: [{
                        data: null,
            ...
            function format(d) {
                ...
                for (let i = 0; i < d.barang.length; i++) {
                    ...
                    if (d.status == 'ITD Approved') {
                        html +=
                            `<td><button class="btn btn-sm btn-light btn-cetak border"><i class="fas fa-print"></i></button></td>`
                    } else {
                        html += `<td> N/A </td>`
                    }
                    html += `</tr>`
